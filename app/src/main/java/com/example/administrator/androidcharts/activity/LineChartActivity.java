...
import static com.example.administrator.androidcharts.R.id.btn_lineChart_cirlce;

public class LineChartActivity extends BaseActivity {

    private LineChart mLineChart;
    private Button mBtnShadow, mBtnCircle;
    ...
    public void onContentChanged() {
        ...
        mBtnCircle = (Button) findViewById(btn_lineChart_cirlce);
        setOnViewClickListener(mBtnShadow,mBtnCircle);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_lineChart_cirlce:
                if (lineDataSet != null){
